...
- **Docs** — [design pattern](docs/design-pattern.md) · [system design](docs/system-design.md) · AI learning notes: [1. first LLM call](docs/ai-learning/01-first-llm-call.md), [2. semantic search](docs/ai-learning/02-embeddings-semantic-search.md), [3. RAG](docs/ai-learning/03-rag-ask-the-blog.md), [4. safety & evals](docs/ai-learning/04-safety-and-evals.md), [5. agents](docs/ai-learning/05-agent-tool-calling.md), [6. command bar & WebMCP](docs/ai-learning/06-command-bar-and-webmcp.md), [7. remote MCP server](docs/ai-learning/07-remote-mcp-server.md)
